...
class DetectionDataset(Dataset):
    ...
    Args:
        ...
        transform (callable, optional): A function/transforms that takes in a PIL image
            and returns a transformed version. E.g,  ``transforms.ToImage``
    """

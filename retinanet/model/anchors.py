...
class AnchorGenerator(nn.Module):
    ...
    def __init__(
        ...
        # Intotal there are A=9 anchors at each feature map for each pixel
    ...
    def generate_cell_anchors(sizes, aspect_ratios) -> Tensor:
        ...
        Args:
            ...
            aspect_ratios (tuple[float]): aspect ratios
    ...
    def forward(self, images: ImageList, feature_maps: List[Tensor]) -> List[Tensor]:
        ...
        anchors = []
        # calculate anchors for all Images
        for i, (_, _) in enumerate(images.image_sizes):
            # Generate anchors for all Images
